    ...
    override fun Content() {
        ...
        if (tripPendingDelete != null) {
            AlertDialog(
                ...
                text = { Text("This trip will be permanently deleted. This cannot be undone.") },
                confirmButton = {
                    TextButton(
                        onClick = {
                            model.deleteTrip(tripPendingDelete!!)
                    ...
                    LazyColumn(
                        ...
                        if (completedTrips.isNotEmpty()) {
                            ...
                            items(completedTrips, key = { it.id }) { trip ->
                                TripCard(trip, onDelete = { tripPendingDelete = trip.id })
                            }
                        }
                    }
                }
